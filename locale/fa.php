...
define('_page_title', "معرفی دانشکده های فنی و حرفه ای");
define('_add_uni_input_fa', "فارسی");
define('_add_uni_input_en', "انگلیسی");

define('_image_logo_error_datat_content', "حداقل اندازه تصویر 200*200 و نسبت طول به عرض آن میبایست برابر با یک(1) باشد.");
define('_image_error_title', "خطا در عکس انتخاب شده");
define('_image_error_data_content', "حداقل عرض تصویر 300 و نسبت طول به عرض آن میبایست بیشتر از یک و نیم(1.5) باشد.");
?>